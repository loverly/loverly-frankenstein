...
/**
 * Return an object for the constructors of the mongoose schema types.
 *
 */
MongoOdm.prototype.getSchemaTypes = function () {
  return {
    ObjectId: this.Mongoose.Schema.Types.ObjectId,
    Mixed: this.Mongoose.Schema.Types.Mixed
  };
};
...
MongoOdm.prototype.conformMongooseInstanceApiToFrankenstein = function (schema) {
  ...
  schema.methods.destroy = function (callback) {
    var _this = this;
    var promise = {
