 ...
 * @method method
 */
Client.prototype.generateQueryHttpOptions = function (query, options) {
...
Client.prototype.count = function (params, options, callback) {
  ...
  optionsCopy.limit = 0;
  var httpOptions = this.generateQueryHttpOptions(query, optionsCopy);
...
Client.prototype.list = function (params, options, callback) {
  ...
  var httpOptions = this.generateQueryHttpOptions(query, options);
