  ...
  for (i in definition) {
    ...
    if (typeof field === 'undefined' || field === null) {
      if (typeof definition[i].defaultValue !== 'undefined') {
        ...
        if (typeof definition[i].defaultValue === 'function') {
          data[i] = definition[i].defaultValue();
        } else {
          data[i] = definition[i].defaultValue;
        }
...
Instance.prototype.bindSourceInstanceToSelf = function (definition, target, source, instance) {
  ...
  for (i in definition) {
    ...
    if (mapping.source && mapping.type !== MAPPING_TYPES.MODEL_REFERENCE && mapping.source !== source.name) {
      continue;
    }
